    ...
    return (
        ...
        <div className='flex flex-col items-center lg:flex-row justify-between'>
            <div>
                ...
                Our services encompass integrating medical reminders and various potential health check-ups into this website.
                </p>
            </div>
            <div className='mt-4 lg:mt-0'>
                <Button title='See service'/>
            </div>
        </div>
        <div className='flex flex-col lg:flex-row gap-5 pt-14'>
            <ServicesCard icon={icon1} title="Medical Reminder"/>
